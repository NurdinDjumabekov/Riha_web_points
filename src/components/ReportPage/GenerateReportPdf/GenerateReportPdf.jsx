...
const GenerateReportPdf = (props) => {
  ...
  console.log(listReport, "listReport"); //suppliers

  return (
    <>
      <div className="genearateReportEveryDay">
        <button className="actionPdf">
          <DescriptionIcon />
        ...
        <Document>
          <Page size="A4" style={styles.page}>
            <View style={styles.section}>
              ...
              <Text style={styles.header}>Реализатор: {data?.seller_fio}</Text>
            </View>
